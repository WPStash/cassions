...
function cassions_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'cassions_custom_background_args', array(
...
function cassions_scripts() {
	...
	wp_enqueue_script( 'cassions-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'cassions-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
